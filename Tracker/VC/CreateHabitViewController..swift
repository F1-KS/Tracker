...
protocol CreateHabitViewControllerDelegate: AnyObject {
    func didCreateNewHabit(model: TrackerStruct)
...
final class CreateHabitViewController: UIViewController {
    ...
    private lazy var nameField: CustomTextField = {
        ...
        field.backgroundColor = UIColor(named: "ypBackgroundDay")
    ...
    private lazy var cancelButton: UIButton = {
        ...
        button.layer.borderColor = UIColor.color(for: "ypRed").cgColor
    ...
    @objc private func didTapCreateButton() {
        ...
        let tracker = TrackerStruct(
            ...
            color: UIColor(named: "ypColorSelection\(emojiNumber % mockEmojis.count + 1)")!,
    ...
    private func setupNavigationBar() {
        let titleAttributes = [
            NSAttributedString.Key.foregroundColor: UIColor.color(for: "ypBlackDay"),
