...
final class TrackerCollectionViewCell: UICollectionViewCell {
    ...
    private let emojiView: UIView = {
        let view = UIView()
        view.backgroundColor = UIColor(named: "ypBackgroundDay")
    ...
    private let nameLabel: UILabel = {
        ...
        label.textColor = UIColor(named: "ypWhiteDay")
    ...
    func configure(model: TrackerStruct, at indexPath: IndexPath, isCompleted: Bool, completedDays: Int) {
        ...
        let image = isCompleted ? UIImage(named: "CheckMarkButton") : UIImage(named: "plus")
        incrementButton.setImage(image?.withTintColor(UIColor(named: "ypWhiteDay")!), for: .normal)
    ...
    @objc private func incrementDayCounter() {
        ...
        if isCompleted {
            delegate?.unfinishedTracker(with: trackerID, at: indexPath)
        } else {
            delegate?.finishedTracker(with: trackerID, at: indexPath)
        }
    }
